...
export type Lang = keyof typeof defaultLabels;
export type LabelKey = keyof (typeof defaultLabels)["ja"];

export function getLabel(
  key: LabelKey,
  opts: { lang?: Lang; override?: any; params?: any } = {}
) {
  let { lang = "ja", override = {}, params = {} } = opts;
  const safeLang = (lang in defaultLabels ? lang : "ja") as Lang;
  let str =
